...
{
    private static readonly Dictionary<string, Type> Scripts = new(StringComparer.OrdinalIgnoreCase);
        ...
        where TScript : class
    {
        ...
        var data = new Dictionary<string, TScript>(StringComparer.OrdinalIgnoreCase);
