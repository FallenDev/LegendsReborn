...
{
    private const string Conn = "Data Source=.;Initial Catalog=Zolian;Integrated Security=True;Encrypt=False";
    private const string BoardConn = "Data Source=.;Initial Catalog=ZolianBoardsMail;Integrated Security=True;Encrypt=False";
    private const string WorldMapsConn = "Data Source=.;Initial Catalog=ZolianWorldMaps;Integrated Security=True;Encrypt=False";
    private const string MapsConn = "Data Source=.;Initial Catalog=ZolianMaps;Integrated Security=True;Encrypt=False";
    private const string AbilitiesConn = "Data Source=.;Initial Catalog=ZolianAbilities;Integrated Security=True;Encrypt=False";
    private const string MonstersConn = "Data Source=.;Initial Catalog=ZolianMonsters;Integrated Security=True;Encrypt=False";
    private const string MundanesConn = "Data Source=.;Initial Catalog=ZolianMundanes;Integrated Security=True;Encrypt=False";
    ...
    public static void CacheFromDatabase(Template temp)
    {
        switch (temp)
        {
            case WorldMapTemplate _:
                WorldMaps(WorldMapsConn);
                break;
            case WarpTemplate _:
                WorldWarps(MapsConn);
                break;
            case SkillTemplate _:
                Abilities(AbilitiesConn, 1);
                break;
            case SpellTemplate _:
                Abilities(AbilitiesConn, 2);
                break;
            case ItemTemplate _:
                Items(Conn);
                break;
            ...
            case MonsterTemplate _:
                Monsters(MonstersConn);
                break;
            case MundaneTemplate _:
                Mundanes(MundanesConn);
                break;
            case BoardTemplate _:
                BoardsPosts(BoardConn);
                break;
        }
    }
    ...
    private static void Items(string conn)
    {
        try
        {
            string[] dbTables = ["Consumables", ];
            string[] dbTables1 = ["ArmorArcanus",];
            string[] dbTables2 = ["Belts", ];
            string[] dbTables3 = ["WeaponPeasant",];
