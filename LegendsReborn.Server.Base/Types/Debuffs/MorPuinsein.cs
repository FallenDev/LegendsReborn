...
public class MorPuinsein : DebuffBase
{
    ...
    public override void OnApplied(Sprite affected, int? timeLeft = null)
    {
        ...
        affected.SendAnimation(196, affected, affected);
    ...
    public override void OnDurationUpdate(Sprite affected)
    {
        ...
        if(affected is Aisling aisling)
            aisling.Client.SendMessage(0x02, "A powerful poison flows through your veins.");
